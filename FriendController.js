angular.module('allMyFriends').controller('FriendController', function($scope) {
...
$scope.badFriends = [
  ...
  $scope.friends = $scope.badFriends.map(function(e) {
  if (e.current_location === null) {
    e.current_location = '';
    return e;
  }
  else if (e.current_location !== null) {
    return e;
  }
});
